...
\begin{frame}
  \frametitle{Contexto}
  \begin{itemize}
    \item<1-> Relação: subconjunto do produto Cartesiano de dois (ou mais)
        conjuntos quaisquer
    \begin{itemize}
      \item $\equiv_n$, a congruência módulo $n$ em $\mathbb{Z}$, ou seja,
          $x \equiv y \pmod{n}$
    \end{itemize}
    \item<2-> Propriedades de relações: reflexividade, irreflexividade,
        simetria, assimetria, antissimetria, transitividade
    \begin{itemize}
      \item $\equiv_n$ é uma relação de equivalência
    \end{itemize}
    \item<3-> É intuitivo pensar que relações são utilizadas para construir
        ordenamentos
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item<2-> Ideia geral: comparação de (alguns) elementos entre conjuntos
        quaisquer
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \end{tikzpicture}
  \begin{itemize}
    \item<1-> Considere o \emph{poset} de divisores de $60$ e $K = \{6, 15\}$
    \begin{itemize}[itemsep=0pt]
      \item<2-> A cota superior é $\{30, 60\}$, a cota inferior é $\{1, 3\}$,
          $\inf(K) = 30$ e $\sup(K) = 3$
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \end{tikzpicture}
  \begin{itemize}
    \item<1-> Considere o \emph{poset} acima e $K = \{a, c, d, f\}$
    \begin{itemize}[itemsep=0pt]
      \item<2-> A cota superior é $\{f, h, j\}$, a cota inferior é $\{a\}$,
          $\inf(K) = f$ e $\sup(K) = a$
    \end{itemize}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Leitura das páginas 618--626 e resolução dos exercícios 1--2, 5--6,
        9--11, 13--16, 18, 20--25, 32--35, nas páginas 630--631
  \end{itemize}
\end{frame}
