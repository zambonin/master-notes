...
\newcolumntype{A}{>{\centering\arraybackslash}m{7cm}}
...
\begin{table}[htbp]
\begin{tabular}{lLLLL}
& security level (bit) & signature size (bit) & private key size (KB)  & public key size (KB) \\
R$(\mathbb{F}_{{2}^{4}}, 17, 23, 17)$           & \multirow{6}{*}{80}  & 228                  & \multirow{2}{*}{21.9}  & 33.4                 \\
CR$(\mathbb{F}_{{2}^{4}}, 17, 23, 17)$     &                      &                      &                        & 15.6                 \\
Rainbow$(\mathbb{F}_{{2}^{5} - 1}, 14, 19, 14)$       &                      & 256                  & \multirow{2}{*}{17.1}  & 25.3                 \\
CyclicRainbow$(\mathbb{F}_{{2}^{5} - 1}, 14, 19, 14)$ &                      &                      &                        & 12.0                 \\
Rainbow$(\mathbb{F}_{{2}^{8}}, 17, 17, 13)$           &                      & 344                  & \multirow{2}{*}{19.1}  & 25.1                 \\
CyclicRainbow$(\mathbb{F}_{{2}^{8}}, 17, 17, 13)$     &                      &                      &                        & 10.4                 \\
Rainbow$(\mathbb{F}_{{2}^{8}}, 26, 16, 17)$           & \multirow{2}{*}{100} & 472                  & \multirow{2}{*}{45.0}  & 59.0                 \\
CyclicRainbow$(\mathbb{F}_{{2}^{8}}, 26, 16, 17)$     &                      &                      &                        & 21.7                 \\
Rainbow$(\mathbb{F}_{{2}^{8}}, 36, 21, 22)$           & \multirow{2}{*}{128} & 632                  & \multirow{2}{*}{102.5} & 136.1                \\
