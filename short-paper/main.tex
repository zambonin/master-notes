...
\usepackage{amsfonts, geometry, multirow, parskip, hyperref}
\geometry{
    paperheight = 11in,
    paperwidth  = 8.5in,
    left   = 1.0in,
...
\begin{table}[]
\begin{tabular}{lllll}
security level (bit) & instance                                        & signature size (bit) & private key size (KB)  & public key size (KB) \\
\multirow{6}{*}{80}  & Rainbow$(\mathbb{F}_{2}^{4}, 17, 23, 17)$       & \multirow{2}{*}{228} & \multirow{2}{*}{21.9}  & 33.4                 \\
                     ...
                     & Rainbow$(\mathbb{F}_{2}^{4}, 14, 19, 14)$       & \multirow{2}{*}{256} & \multirow{2}{*}{17.1}  & 25.3                 \\
                     & CyclicRainbow$(\mathbb{F}_{2}^{4}, 14, 19, 14)$ &                      &                        & 12.0                 \\
                     & Rainbow$(\mathbb{F}_{2}^{4}, 17, 17, 13)$       & \multirow{2}{*}{344} & \multirow{2}{*}{19.1}  & 25.1                 \\
                     & CyclicRainbow$(\mathbb{F}_{2}^{4}, 17, 17, 13)$ &                      &                        & 10.4                 \\
\multirow{2}{*}{100} & Rainbow$(\mathbb{F}_{2}^{4}, 26, 16, 17)$       & \multirow{2}{*}{472} & \multirow{2}{*}{45.0}  & 59.0                 \\
                     & CyclicRainbow$(\mathbb{F}_{2}^{4}, 26, 16, 17)$ &                      &                        & 21.7                 \\
\multirow{2}{*}{128} & Rainbow$(\mathbb{F}_{2}^{4}, 36, 21, 22)$       & \multirow{2}{*}{632} & \multirow{2}{*}{102.5} & 136.1                \\
                     & CyclicRainbow$(\mathbb{F}_{2}^{4}, 36, 21, 22)$ &                      &                        & 47.3                
\end{tabular}
\end{table}
