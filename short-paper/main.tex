...
\begin{center}
    ...
    Written for the INE410111 class (Research Methodology in Computer Science), based on from~\cite{Petzoldt:phd:2013:jul}. \textbf{This is not a real paper.} \vspace{.75cm}
\end{center}
