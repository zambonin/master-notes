...
\title{Reducing Public Key Size on the Rainbow Signature Scheme with Cyclic Structures\footnote{Written for the INE410111 class (Research Methodology in Computer Science), based on~\cite{Petzoldt:inproc:2010:dec} from~\cite{Petzoldt:phd:2013:jul}. \textbf{This is not a real paper.}}}
