...
Deriving the size of public keys from the schemes described in Sections~\ref{sec:rainbow} and~\ref{sec:cyclic}, we have that the size for a Rainbow public key is $m \cdot (n + 1)(n + 2)/2$ field elements, and in the case of CyclicRainbow, the size is 
