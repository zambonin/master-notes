...
We apply the rationale above to the key generation step of the Rainbow scheme. We restrict ourselves to the case when $u = 2$, but the generalised process can be found in~\cite[Section 7.2]{Petzoldt:phd:2013:jul}.

The signature generation and verification steps are left unmodified.

\section{Effect of the Construction}\label{sec:effect}

\emph{Security.} As seen in~\cite[Section 9.3]{Petzoldt:phd:2013:jul}, none of the known attacks against the classical Rainbow scheme work better against CyclicRainbow. As such, finding weaknesses in this construction remains an open questi
