...
We focus on reducing the public key size of the Rainbow scheme~\cite{}, a generalised version of the Unbalanced Oil and Vinegar (UOV) scheme~\cite{} that reduces key sizes and signature length. We apply the strategy described in~\cite{}, 
