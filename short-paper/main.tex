...
\usepackage{amsfonts, array, geometry, multirow, parskip, hyperref}
\geometry{
    paperheight = 11in,
    paperwidth  = 8.5in,
    left   = 1.0in,
...
We apply the rationale below to the key generation step of the Rainbow scheme. We restrict ourselves to the case when $u = 2$, but the generalised process can be found in~\cite[Section 7.2]{Petzoldt:phd:2013:jul}. 


Let $D_{1} = v_{1}(v_{1} + 1)/2 + v_{1} o_{1}, D_{2} = v_{2}(v_{2} + 1)/2 + v_{2} o_{2}$ be the number of quadratic terms in the central polynomials of the first and second layers, respectively, and $D_{3} = n(n + 1)/2$ be the number of quadratic terms in the public polynomials.
...
To prevent efficient attacks by known methods, we suggest parameter sets that are similar to the original Rainbow$(\mathbb{F}_{2^{8}}, 17, 13, 13)$. Table~\ref{tab:comp} compares our scheme with regards to various security levels and layer sizes. Note that the reduction factor grows with the increase in the number of polynomials and variables.

\emph{Security.} As seen in~\cite[Section 9.3]{Petzoldt:phd:2013:jul}, none of the known attacks against the classical Rainbow scheme work better against CyclicRainbow. As such, finding weaknesses in this construction remains an open question.

\section{Conclusion}\label{sec:conclusion}

\begin{table}[htbp]
\begin{tabular}{L|A|L|L|L}
security level (bit) & instance                                              & signature (bit) & private key (KB) & public key (KB) \\
\multirow{6}{*}{80}  & Rainbow$(\mathbb{F}_{{2}^{4}}, 17, 23, 17)$           & \multirow{2}{*}{228} & \multirow{2}{*}{21.9}  & 33.4                 \\
                     & CyclicRainbow$(\mathbb{F}_{{2}^{4}}, 17, 23, 17)$     &                      &                        & 15.6                 \\
                     & Rainbow$(\mathbb{F}_{{2}^{5} - 1}, 14, 19, 14)$       & \multirow{2}{*}{256} & \multirow{2}{*}{17.1}  & 25.3                 \\
                     & CyclicRainbow$(\mathbb{F}_{{2}^{5} - 1}, 14, 19, 14)$ &                      &                        & 12.0                 \\
                     & Rainbow$(\mathbb{F}_{{2}^{8}}, 17, 17, 13)$           & \multirow{2}{*}{344} & \multirow{2}{*}{19.1}  & 25.1                 \\
                     & CyclicRainbow$(\mathbb{F}_{{2}^{8}}, 17, 17, 13)$     &                      &                        & 10.4                 \\
\multirow{2}{*}{100} & Rainbow$(\mathbb{F}_{{2}^{8}}, 26, 16, 17)$           & \multirow{2}{*}{472} & \multirow{2}{*}{45.0}  & 59.0                 \\
                     & CyclicRainbow$(\mathbb{F}_{{2}^{8}}, 26, 16, 17)$     &                      &                        & 21.7                 \\
\multirow{2}{*}{128} & Rainbow$(\mathbb{F}_{{2}^{8}}, 36, 21, 22)$           & \multirow{2}{*}{632} & \multirow{2}{*}{102.5} & 136.1                \\
                     & CyclicRainbow$(\mathbb{F}_{{2}^{8}}, 36, 21, 22)$     &                      &                        & 47.3                
\end{tabular}
\end{table}
