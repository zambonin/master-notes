...
With this strategy, we can set $B_{1}$ and $B_{2}$ with elements that generate a succinct structure. Randomly choose vectors $a_{1} \in \mathbb{F}_{q}^{D_{1}}, a_{2} \in \mathbb{F}_{q}^{D_{2} - D_{1}}$
