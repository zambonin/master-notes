...
\title{Partially Cyclic Public Keys on the Rainbow Signature Scheme}
...
Written for the INE410111 class (Research Methodology in Computer Science), based on~\cite{Petzoldt:inproc:2010:jun} from~\cite{Petzoldt:phd:2013:jul}. \textbf{This is not a real paper.}
