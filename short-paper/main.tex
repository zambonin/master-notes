...
\title{Reducing Public Key Size on the Rainbow Signature Scheme with Cyclic Structures\footnote{Written for the INE410111 class (Research Methodology in Computer Science), based on~\cite{Petzoldt:inproc:2010:dec} from~\cite{Petzoldt:phd:2013:jul}, Qualis of B1. \textbf{This is not a real paper.}}}

\author{\underline{Gustavo Zambonin}\inst{1}, Albrecht Petzoldt\inst{2}, Johannes Buchmann\inst{2}}
