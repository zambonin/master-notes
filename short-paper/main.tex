...
\end{equation}
with $k \in \{v_{1} + 1, \dots, n\}$, where $\ell$ is the only integer such that $k \in O_{\ell}$. We hide the structure of $\mathcal{F}$ in the public key through its composition with 
