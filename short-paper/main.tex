...
Eq.~\ref{eq:2} can be represented in a more compact form by creating a $D_{2} \times D_{2}$ matrix $A$ with the coefficients $\alpha_{ij}^{rs}$, ordered with the strategy given above.
