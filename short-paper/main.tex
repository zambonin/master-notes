...
We apply the rationale below to the key generation step of the Rainbow scheme. We restrict ourselves to the case when $u = 2$, but the generalised process can be found in~\cite[Section 7.2]{Petzoldt:phd:2013:jul}. Let $D_{1} = v_{1}(v_{1} + 1)/2 + v_{1} o_{1}, D_{2} = v_{2}(v_{2} + 1)/2 + v_{2} o_{2}$ be the number of quadratic terms in the central polynomials of the first and second layers, respectively, and $D_{3} = n(n + 1)/2$ be the number of quadratic terms in the public polynomials.
