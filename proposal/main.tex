...
dada apenas com funções de resumo criptográficas, construídas a partir de
...
Esquemas de assinatura digital baseados em funções de resumo criptográficas
...
esquema torna-se relativamente eficiente, e a valer, este e sua
...
baseados em funções de resumo criptográficas, como SPHINCS \cite{Bernstein2015},
