...
bloco; o valor da assinatura, para cada

o número de repetições do encadeamento, para cada bloco, é determinado pela fração respectiva do resumo da mensagem que se deseja
assinar. Uma assinatura, portanto, é um conjunto de cadeias de resumos
criptográficos da chave privada.
