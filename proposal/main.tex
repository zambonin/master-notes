...
O esquema de assinatura digital única Winternitz é uma generalização de
\cite{Lamport1979} que permite a assinatura de múltiplos \emph{bits}
simultaneamente, configurado por um parâmetro $w$ que implica imediatamente
no tamanho do par de chaves e na velocidade que a assinatura digital é
...
como parte de diversos esquemas de assinatura digital 
