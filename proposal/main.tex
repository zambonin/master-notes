...
-- as folhas da árvore -- e reduz a verificação destes para uma única
chave -- a raiz da árvore


construída com a concatenação de resumos
criptográficos do conteúdo de nodos, habilitando a assinatura de diversas
mensagens, codificadas nesta árvore. 
