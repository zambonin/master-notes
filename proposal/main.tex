...
nesta estrutura de dados. Por exemplo, no caso do SPHINCS, que utiliza
o conceito de camadas de árvores de Merkle separadas por nodos de
autenticação, WOTS+ é utilizado para autenticar cada uma das camadas de árvores de Merkle
