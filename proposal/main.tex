...
cima do conceito de camadas de árvores de Merkle,


WOTS+ é utilizado para a
autenticação entre estas, a fim de descartar a necessidade de manter o
estado do esquema de assinatura digital.
