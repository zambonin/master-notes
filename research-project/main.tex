...
Nonetheless, current digital signature schemes are proven to be secure only under the assumption that there are no quantum adversaries, \emph{i.e.} any entity with a sufficiently powerful quantum computer can break most popular signature schemes, since
