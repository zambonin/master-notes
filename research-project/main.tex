...
There has been a considerable amount of work done when dealing with reduction of private and public keys on the Rainbow signature scheme. Still, not all of the published works maintain the security \emph{status quo} of their common predecessor. For instance, a scheme based on non-commutative rings due to Yasuda \emph{et al.}~\cite{} was subsequently analysed and broken by independent researchers~\cite{}. Another example is that of a scheme based on circulant matrices due to Peng and Tang~\cite{}, also deemed to be insecure by Hashimoto~\cite{}. 

Still, there are various examples of schemes that resist currently known cryptanalysis, 
