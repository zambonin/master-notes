...
Still, there are various examples of schemes that resist currently known cryptanalysis. Petzoldt \emph{et al.} suggest schemes based on cyclic matrices~\cite{} and linear recurring sequences~\cite{}, that feature reductions of, respectively, $62\%$ and a factor of seven in the public key size. A scheme by Yasuda \emph{et al.}~\cite{} uses sparse matrices to reduce private key sizes by up to $76\%$.
