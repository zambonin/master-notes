...
\begin{enumerate}[label=(\alph*)]
    ...
    \item Develop an algorithm to check if the reduced key space of compact key pairs is still large enough to prevent brute-force search;
    ...
    \item Compare the new algorithm with
